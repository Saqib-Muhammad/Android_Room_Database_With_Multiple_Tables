...
import com.muhammadsaqib.androidroomdatabasewithmultipletables.ui.theme.AndroidRoomDatabaseWithMultipleTablesTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AndroidRoomDatabaseWithMultipleTablesTheme {
